...
<%-- 필요한 클래스를 import 하려면 <%@ page %> page directive(페이지 지시어)를 사용하여 import한다. --%>
...
<% // 이거는 어디에 하든 위치는 상관없음. 문제없음 
	...
	SimpleDateFormat sdfrm = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	String result = sdfrm.format(now);
