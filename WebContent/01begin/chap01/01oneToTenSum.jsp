...
<head>
<meta charset="UTF-8">
<title> 1부터 10까지의 합을 자바에서 구한 다음 그 결과를 HTML로 보여줄 것이다.아,,WebContent부분을 서블릿이라 부르는구나,,</title>
...
%>
	...
	<%-- JSP 주석문 --%>
       ...
       C:\myjsp\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\MyMVC\org\apache\jsp\_01begin\chap01\_01oneToTenSum_jsp.java 와
       C:\myjsp\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\MyMVC\org\apache\jsp\_01begin\chap01\_01oneToTenSum_jsp.class 로 
             저장된다.  
	...
	<h2>
		1부터 10까지의 합은 <span id="result"><%=sum*10%></span> 입니다.
	</h2>
